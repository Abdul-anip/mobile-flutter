...
class _GridElectronicsState extends State<GridElectronics> {
  ...
  Future<void> getAllElectronic() async {
    String urlElectronic =
        "https://servershophanif-production-840f.up.railway.app/gridelectronics.php";
    try {
...
class DetilElectronic extends StatefulWidget {
  final dynamic item;
  const DetilElectronic({super.key, required this.item});

  @override
  State<DetilElectronic> createState() => _DetilElectronicState();
}

class _DetilElectronicState extends State<DetilElectronic> {
