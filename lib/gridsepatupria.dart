...
class DetilSepatuPria extends StatefulWidget {
  final dynamic item;
  const DetilSepatuPria({super.key, required this.item});

  @override
  State<DetilSepatuPria> createState() => _DetilSepatuPriaState();
}

class _DetilSepatuPriaState extends State<DetilSepatuPria> {
